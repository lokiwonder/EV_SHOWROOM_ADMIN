...
export const LANGUAGE = [
  ...
  { label: "Bulgarian - BG", name: "bg" },
  { label: "Croatian - HR", name: "hr" },
  { label: "Chech - CS", name: "cs" },
  { label: "Danish - DA", name: "da" },
  { label: "German - DE", name: "de" },
  { label: "Greek - DL", name: "dl" },
  { label: "English - EN", name: "en" },
  { label: "Estonian - ET", name: "et" },
  { label: "Spanish - ES", name: "es" },
  { label: "Finnish - FI", name: "fi" },
  { label: "French - DR", name: "dr" },
  { label: "Irish - GA", name: "ga" },
  { label: "Hindi - HI", name: "hi" },
  { label: "Hungarian - HU", name: "hu" },
...
export const TMP_COUNTRY = [
  { label: "Belgique - BE", name: "BE" },
  { label: "Bosna i Hercegovina - BA", name: "BA" },
  { label: "Česko - CZ", name: "CZ" },
  { label: "Ceuta - XC", name: "XC" },
  { label: "Danmark - DK", name: "DK" },
  { label: "Deutschland - DE", name: "DE" },
  { label: "Eesti - EE", name: "EE" },
  { label: "España - ES", name: "ES" },
  { label: "France - FR", name: "FR" },
  { label: "Hrvatska - HR", name: "HR" },
  { label: "Ireland - IE", name: "IE" },
  { label: "Ísland - IE", name: "IS" },
  { label: "Islas Canarias - IC", name: "IC" },
  { label: "Italia - IT", name: "IT" },
  { label: "Latvija - LV", name: "LV" },
  { label: "Lietuva - LT", name: "LT" },
  { label: "Magyarország - HU", name: "HU" },
  { label: "Malta - MT", name: "MT" },
  { label: "Nederland - NL", name: "NL" },
  { label: "Norge - NO", name: "NO" },
  { label: "Österreich - AT", name: "AT" },
  { label: "Polska - PL", name: "PL" },
  { label: "Portugal - PT", name: "PT" },
  { label: "România - RO", name: "RO" },
  { label: "Slovenija - SI", name: "SI" },
  { label: "Slovensko - SK", name: "SK" },
  { label: "Suomi - FI", name: "FI" },
  { label: "Sverige - SE", name: "SE" },
  { label: "Swiss - CH", name: "CH" },
  { label: "Türkiye - TR", name: "TR" },
  { label: "United Kingdom - GB", name: "GB" },
  { label: "Ελλάδα - GR", name: "GR" },
  { label: "Κυπριακή - CY", name: "CY" },
  { label: "България - BG", name: "BG" },
